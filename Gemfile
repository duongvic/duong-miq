...
# VMDB specific gems
#
gem "manageiq-gems-pending", ">0", :require => 'manageiq-gems-pending', :git => "https://khanhct:o1WuT9jzav6X-Yu_N7vy@git.fptcompute.com.vn/portal/manageiq-gems-pending.git", :tag => "production"
# gem 'manageiq-gems-pending', ">0", :path => 'plugins/manageiq-gems-pending'
...
def manageiq_custom_plugin(plugin_name)
  unless dependencies.detect { |d| d.name == plugin_name }
    gem plugin_name, :git => "https://khanhct:o1WuT9jzav6X-Yu_N7vy@git.fptcompute.com.vn/portal/#{plugin_name}.git", :tag => "production"
  end
end

manageiq_custom_plugin "manageiq-schema"
# gem 'manageiq-schema', :path => 'plugins/manageiq-schema'

manageiq_custom_plugin 'benji-client'
# gem 'benji-client', :path => 'plugins/benji-client'

manageiq_custom_plugin 'netbox-client-ruby'
# gem 'netbox-client-ruby', :path => 'plugins/netbox-client-ruby'

manageiq_custom_plugin 'ceph-client'
# gem 'ceph-client', :path => 'plugins/ceph-client'

manageiq_custom_plugin 'prometheus-api-client'
# gem 'prometheus-api-client', :path => 'plugins/prometheus-api-client'

manageiq_custom_plugin "fog-openstack"
# gem 'fog-openstack', :path => 'plugins/fog-openstack'
...
gem 'jwt',                            '~> 1.5', '>= 1.5.4'
gem 'rotp',                           '~> 3.1',         :require => false
gem 'uglifier',                       '~> 4.2',         :require => false
gem 'grpc',                           '>= 1.38.0',      :require => false
gem 'grpc-tools',                     '~> 1.38.0',      :require => false
gem "rqrcode",                        "~> 2.0"
...
group :openstack, :manageiq_default do
  manageiq_custom_plugin "manageiq-providers-openstack"
  # gem "manageiq-providers-openstack", :path => 'plugins/manageiq-providers-openstack'
end
...
group :automate, :seed, :manageiq_default do
  ...
  # gem 'manageiq-automation_engine', :path => 'plugins/manageiq-automation_engine'
end
...
group :rest_api, :manageiq_default do
  manageiq_custom_plugin "manageiq-api"
  # gem 'manageiq-api', :path => 'plugins/manageiq-api'
end
...
group :seed, :manageiq_default do
  # gem 'manageiq-content', :path => 'plugins/manageiq-content'
  manageiq_custom_plugin "manageiq-content"
end
...
group :ui_dependencies do # Added to Bundler.require in config/application.rb
  manageiq_custom_plugin "manageiq-decorators"
  # gem 'manageiq-decorators', :path => 'plugins/manageiq-decorators'
  manageiq_custom_plugin "manageiq-ui-classic"
  # gem 'manageiq-ui-classic', :path => 'plugins/manageiq-ui-classic'
  # Modified gems (forked on Github)

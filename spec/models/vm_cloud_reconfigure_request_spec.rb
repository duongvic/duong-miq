  ...
  describe "#make_request" do
    ...
    it "creates and update a request" do
      ...
      expect(AuditEvent).to receive(:success).with(
        ...
        :target_class => "Vm",
        :userid       => admin.userid,
        :message      => "VM Reconfigure requested by <#{admin.userid}> for Vm:#{[vm_amazon.id].inspect}"
      )
      ...
      expect(request.description).to    eq("VM Reconfigure for: #{vm_amazon.name} - Flavor: ")
      ...
      expect(AuditEvent).to receive(:success).with(
        ...
        :message      => "VM Reconfigure request updated by <#{alt_user.userid}> for Vm:#{[vm_amazon.id].inspect}"
      )

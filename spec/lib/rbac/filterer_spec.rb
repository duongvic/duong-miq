RSpec.describe Rbac::Filterer do
  ...
  context "common setup" do
    ...
    context "with cloud network and Region" do
      ...
      context "Region with/without tagging" do
        ...
        context "Region is tagged" do
          ...
          it "lists only tagged Region" do
            User.with_user(user) do
        ...
        context "Region not is tagged" do
          before do
            group.entitlement = Entitlement.new
            group.entitlement.set_managed_filters([])
            group.entitlement.set_belongsto_filters([])

  ...
  module Support
    module QuotaHelper
      ...
      def create_tenant_quota
        ...
        @tenant.tenant_quotas.create(:name => :cloud_networks_allocated, :value => 4)
        @tenant.tenant_quotas.create(:name => :cloud_subnets_allocated, :value => 4)
        @tenant.tenant_quotas.create(:name => :load_balancers_allocated, :value => 4)
      end

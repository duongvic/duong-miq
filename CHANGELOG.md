...
- Fix saving Region in belongsto filter [(#18504)](https://github.com/ManageIQ/manageiq/pull/18504)
...
- Regions discovery without unspecified discovery types (FIX) [(#17229)](https://github.com/ManageIQ/manageiq/pull/17229)
...
- Regions
  ...
  - Adds virtual totals for servers vms and hosts to Physical Infrastructure Regions [(#15613)](https://github.com/ManageIQ/manageiq/pull/15613)
  ...
  - Pluggable Regions: allow seeding of dialogs from plugins [(#14668)](https://github.com/ManageIQ/manageiq/pull/14668)
...
- RBAC
  ...
  - Move rule for Region to belonsto filter [(#16063)](https://github.com/ManageIQ/manageiq/pull/16063)
...
- RBAC
  - Move rule for Region to belongsto filter [(#16063)](https://github.com/ManageIQ/manageiq/pull/16063)
- Reporting
  - Cast virtual attribute 'Hardware#ram_size_in_bytes' to bigint [(#15554)](https://github.com/ManageIQ/manageiq/pull/15554)
  - Unconditionally seed all standard reports and widgets [(#16062)](https://github.com/ManageIQ/manageiq/pull/16062)
- REST API
...
- User Interface
  ...
  - Login Start Pages dropdown list - Virtual Data Center menus [(#15017)](https://github.com/ManageIQ/manageiq/pull/15017)
  - Fix for custom button not passing target object to dynamic dialog fields [(#15810)](https://github.com/ManageIQ/manageiq/pull/15810)
...
- User Interface (Classic)
  ...
  - Adding Physical Infra Regions Menu Item [(#13587)](https://github.com/ManageIQ/manageiq/pull/13587)
...
- Ansible Tower Jobs moved to the Configuration tab (from Virtual Data Center/Stacks)
...
- Add GUID validation for certain Azure fields in Region screen
...
- Topology for Infrastructure Regions
...
- General
  ...
  - Update authentication status when clicking validate for existing Regions.
  - Hosts and Regions now default to use the hostname column for communication instead of IP address.    
- SCVMM

Vmdb::Application.configure do
  ...
  config.backup_url = 'http://172.16.1.253:5000/api/v1/benji'
  config.backup_grpc = '172.16.1.253:55051'

  config.ceph_url = 'http://172.16.0.113:8443/api'
  config.ceph_credentials = {:username => 'admin',
                             :password => 'WujN3oc7iVImR0UP'}

  config.action_mailer.default_url_options = {:host => 'dashboard.fptvds.vn', :protocol => 'https'}

...
module SupportsFeatureMixin
  ...
  QUERYABLE_FEATURES = {
    ...
    :set_gateway                         => 'Set Gateway Router',
    :clear_gateway                       => 'Clear Gateway Router',
    :add_static                          => 'Add Static Routes',
    :remove_static                       => 'Remove Static Routes',
    ...
    :create_load_balancer                => 'Load Balancer Creation',
    ...
    :delete_load_balancer                => 'Load Balancer Creation',
    ...
    :remove_load_balancer                => 'Remove Load Balancer',
    ...
    :update_load_balancer                => 'Load Balancer Update',

module ManageIQ::Providers
  class NetworkManager < BaseManager
    ...
    has_many :backup_schedules,              -> { where.not(:ems_id => nil) }, :primary_key => :parent_ems_id, :foreign_key => :ems_id
    ...
    def name
      # Fix name by parent name
      "#{parent_manager.try(:name)}"
    end

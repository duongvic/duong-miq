module ManageIQ::Providers
  class CloudManager < BaseManager
    ...
    has_many :backup_schedules,              :foreign_key => :ems_id, :dependent => :destroy
    ...
    def sync_root_tenant
      ...
      ems_tenant_name = "#{self.class.description} Provider #{name}"
    ...
    def self.display_name(number = 1)
      n_('Provider Manager', 'Provider Managers', number)
    end
